...
var BlankonApp = (function() {
  return {
    ...
    handleSound: function() {
      // alert(BlankonApp.handleBaseURL());
      // OJO EBERT
      if ($(".page-sound").length) {
        ion.sound({
          ...
          path:
            BlankonApp.handleBaseURL() +
            "src/assets/global/plugins/bower_components/ionsound/sounds/",
          preload: true
        });
    ...
    handleSidebarScroll: function() {
      ...
      function checkHeightSidebar() {
        ...
        if ($(".page-sidebar-fixed").length) {
          ...
          var heightSidebarLeft =
            $(window).outerHeight() -
            $("#header").outerHeight() -
            $(".sidebar-footer").outerHeight() -
            $(".sidebar-content").outerHeight();

          $("#sidebar-left .sidebar-menu")
            .height(heightSidebarLeft)
            .niceScroll({
              cursorwidth: "10px",
              cursorborder: "0px",
              railalign: "left"
        ...
        var heightSidebarRight =
            $(window).outerHeight() -
            $("#sidebar-right .panel-heading").outerHeight(),
          heightSidebarRightChat =
            $(window).outerHeight() -
            $("#sidebar-right .panel-heading").outerHeight() -
            $("#sidebar-chat .form-horizontal").outerHeight();

        // Sidebar right profile
        $("#sidebar-profile .sidebar-menu")
          .height(heightSidebarRight)
          .niceScroll({
            cursorwidth: "10px",
            cursorborder: "0px"
          });
        ...
        // Sidebar right chat
        $("#sidebar-chat .sidebar-menu")
          .height(heightSidebarRightChat)
          .niceScroll({
            cursorwidth: "10px",
            cursorborder: "0px"
          });
    ...
    handleSidebarResponsive: function() {
      ...
      $(".navbar-minimize a").on("click", function() {
        ...
        if (
          $.cookie("page_sidebar_minimize") == "undefined" ||
      ...
      $(".navbar-setting a").on("click", function() {
        ...
        if ($(".page-sidebar-minimize.page-sidebar-right-show").length) {
          $("body").toggleClass(
            "page-sidebar-minimize page-sidebar-right-show"
          );
    ...
    handleTypehead: function() {
      if ($(".typeahead").length) {
        ...
        repos = new Bloodhound({
          ...
          prefetch:
            BlankonApp.handleBaseURL() +
            "src/assets/global/plugins/bower_components/typehead.js/dist/typeahead-sample.json"
        });
          ...
          templates: {
            ...
            suggestion: Handlebars.compile(
              [
                ...
                '<span class="media-left">' + '<span class="media-object">',
    ...
    handlePanelToolAction: function() {
      ...
      $("[data-action=collapse]").on("click", function(e) {
        var targetCollapse = $(this)
            .parents(".panel")
            .find(".panel-body"),
          targetCollapse2 = $(this)
            .parents(".panel")
            .find(".panel-sub-heading"),
          targetCollapse3 = $(this)
            .parents(".panel")
            .find(".panel-footer");
      ...
      $("[data-action=refresh]").on("click", function() {
        ...
        setInterval(function() {
          $.getJSON(
            BlankonApp.handleBaseURL() +
              "/assets/admin/data/reload-sample.json",
            function(json) {
              $.each(json, function() {
    ...
    handleSparkline: function() {
      if ($(".sparklines").length) {
        $(".average").sparkline("html", {
          type: "bar",
          barColor: "#37BC9B",
          height: "30px"
        });
        $(".traffic").sparkline("html", {
          type: "bar",
          barColor: "#8CC152",
          height: "30px"
        });
    ...
    handleBoxModal: function() {
      ...
      $("#lock-screen").on("click", function() {
        ...
        bootbox.dialog({
          message:
            "Locker with notification display, Receive your notifications directly on your lock screen",
          title: "Lock Screen",
