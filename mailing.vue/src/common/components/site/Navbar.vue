      ...
      <header id="header">
        ...
        <div class="header-left">
          ...
          <div class="navbar-header">
            ...
            <!-- Start brand -->
            <router-link tag="a" :to="{name:'cartelera'}" class="navbar-brand">
              <img class="logo" :src="logo_white" width="175" :alt="appname" :title="appname">
            </router-link>
            <!-- /.navbar-brand -->
            <!--/ End brand -->
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown navbar-message hide">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="count label label-danger rounded">7</span>
                </a>
                  ...
                  <div class="dropdown-body">
                    ...
                    <div class="media-list niceScroll">
                      ...
                      <a href="page-messages.html" class="media">
                        <div class="pull-left">
                          <img src="http://img.djavaui.com/?create=50x50,4888E1?f=ffffff" class="media-object img-circle" alt="..." />
                        </div>
                      ...
                      <a href="page-messages.html" class="media">
                        ...
                        <div class="media-body">
                          ...
                          <span class="media-text">Great work! Do you have any plans to add loading indicators for AJAX calls that might take longer than
                            normal?</span>
                          <!-- Start meta icon -->
              ...
              <!-- /.dropdown navbar-message -->
              <!--/ End messages -->

              <!-- Start notifications -->
              <li class="dropdown navbar-notification hide">
                    ...
                    <div class="media-list small">
                      ...
                      <a href="#" class="media">
                        <div class="media-object pull-left">
                          <i class="fa fa-share-alt fg-info"></i>
                        </div>
                        <div class="media-body">
                      ...
                      <a href="#" class="media">
                        <div class="media-object pull-left">
                          <i class="fa fa-cogs fg-success"></i>
                        </div>
                        <div class="media-body">
                      ...
                      <a href="#" class="media">
                        <div class="media-object pull-left">
                          <img class="img-circle" src="http://img.djavaui.com/?create=30x30,4888E1?f=ffffff" alt="..." />
                        </div>
                        <div class="media-body">
              ...
              <li class="dropdown navbar-profile">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="meta">
                    <span class="avatar">
                      <img :src="avatar" class="img-circle" alt="admin">
                    </span>
                    <span class="text hidden-xs hidden-sm text-muted">{{usuario.nombre|capitalize}}</span>
                ...
                <ul class="dropdown-menu animated flipInX">
                  ...
                  <li>
                    <a href="mail-inbox.html">
                      <i class="fa fa-envelope-square"></i>Inbox
                      <span class="label label-info pull-right">30</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-share-square"></i>Invite a friend</a>
                  </li>
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-dollar"></i>Earning</a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-download"></i>Withdrawals</a>
                  </li>
                  <li class="divider"></li>
                  <li>
                    <router-link tag="a" :to="{name:'ingresar'}">
              ...
              <!-- Start settings -->
              <li class="navbar-setting pull-right hide">
...
export default {
  computed: {
    ...mapGetters(["appname", "logo_white", "usuario", "avatar"])
  },
  mounted() {
    try {
      // alert("BlankonApp.init();");
      // if (typeof BlankonApp.init === "function") {
